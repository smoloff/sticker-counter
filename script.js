...
let newElement = [
    {name: tagName, type: type, id: id, className: class, inner: innerHTML, holder: placeholder } // переписать все из  20 строки
]
...
newElement.forEach(element => {
    ...
    let inputHeight = createHTMLElement ("input", "height", element.idHeight, "", "", "width");
